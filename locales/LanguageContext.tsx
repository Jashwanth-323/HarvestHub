...
const enTranslations = {
  ...
  auth: {
    ...
    role: {
        ...
        admin: "I'm an Admin", // New key
        adminDesc: "Manage users, products, orders, disputes, and system settings." // New key
    },
    ...
    adminDemoCredentials: "Admin demo credentials: Email: admin@example.com | Password: admin@123" // New key
  },
  dashboard: {
    welcome: "Welcome",
    overview: "Overview",
  ...
  productDetail: {
    recipeIdeasTitle: "Need a Recipe Idea?",
    generateRecipeButton: "Generate a {{productName}} Recipe",
    generatingRecipe: "Generating...",
    recipeGenerationError: "Sorry, an error occurred while generating the recipe.",
    relatedProductsTitle: "Related Products", // New key
    noRelatedProducts: "No related products found in this category." // New key
  },
  about: {
    title: "About Us",
